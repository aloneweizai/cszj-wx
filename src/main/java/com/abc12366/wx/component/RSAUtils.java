 ...
 * @create 2017-09-12 5:32 PM
 * @since 1.0.0
 */
public class RSAUtils {
    protected static Logger _log = LoggerFactory.getLogger(RSAUtils.class);
    ...
    public static KeyPair getKeyPair(String basePath) throws Exception {
        ...
        FileInputStream fis = new FileInputStream(!StringUtils.isEmpty(basePath) ? (basePath + RSAKeyStore) :
                RSAKeyStore);
    ...
    public static void saveKeyPair(KeyPair kp, String basePath) throws Exception {
        ...
        FileOutputStream fos = new FileOutputStream(!StringUtils.isEmpty(basePath) ? (basePath + RSAKeyStore) :
                RSAKeyStore);
    ...
    public static String decryptFromJS(PrivateKey pk, String paramStr, String encode) throws Exception {
        ...
        byte[] de_result = RSAUtils.decrypt(pk, en_result);
...
//        keyPair = getKeyPair(config.getValue("keyStorePath") + "/");
//
//        if (keyPair == null) {
//            keyPair = generateKeyPair();
//            saveKeyPair(keyPair, config.getValue("keyStorePath") + "/");
//        }
//        return keyPair;
//    }
